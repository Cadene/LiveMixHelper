...
<?php echo $this->Form->create('Music'); ?>
	<fieldset>
		<legend><?php echo __('Edit Music'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Music.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Music.id'))); ?></li>
